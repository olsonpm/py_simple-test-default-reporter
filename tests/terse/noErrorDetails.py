...
from ..utils import getActualOut
from .expected import noErrorDetails as expected
import simple_test_default_reporter
...
def report(state):
    return simple_test_default_reporter.report(state, showErrorDetails=False)
